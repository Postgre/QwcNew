...
public class ShareModel implements OnClickListener {
	...
	public PopupWindow initPopuptWindow() {
		...
		/*((TextView) popupWindow.findViewById(R.id.QzoneShare))
				.setOnClickListener(this);
		((TextView) popupWindow.findViewById(R.id.QQShare))
				.setOnClickListener(this);*/
		// 创建一个PopupWindow
	...
	public void SetController(final String intro, final String name,
		...
		// WXCriShare
		wxCircleHandler = new UMWXHandler(a, Constants.WXappID , Constants.WXSecret);
	...
	private void WXShare() {
		...
		mController
				.postShare(a, SHARE_MEDIA.WEIXIN, null);
	}
	...
	private void WXCriShare() {
		...
		mController.postShare(a, SHARE_MEDIA.WEIXIN_CIRCLE,
				null);
	}
	...
	private void qzoneShare() {
		// TODO Auto-generated method stub
		// QZoneShare
		qZoneSsoHandler = new QZoneSsoHandler(a, QzoneApp_Id,
				QzoneApp_Key);
