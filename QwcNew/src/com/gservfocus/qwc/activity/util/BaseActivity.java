...
public abstract class BaseActivity extends Activity implements OnClickListener,
	...
	public final void showToast(String msg) {
		...
		View view = inflater.inflate(R.layout.gsf_custom_toast, null);
	 ...
	 *            显示的内容
	 */
	public final void showKwayiToast(String msg , int score) {
		// Toast.makeText(this, msg, 1000).show();
		LayoutInflater inflater = LayoutInflater.from(this);
		View view = inflater.inflate(R.layout.kawayi_custom_toast, null);
		ImageView image = (ImageView) view.findViewById(R.id.toastbackbround);
		if(!Teacher.getTeacher(this).isBoy()){
			image.setImageResource(R.drawable.girl_grade);
		}else{
			image.setImageResource(R.drawable.boy_grade);
		}
		TextView textView = (TextView) view.findViewById(R.id.toast_txt_info);
		TextView textView1 = (TextView) view.findViewById(R.id.toast_txt_info1);
		textView1.setText("总计"+(Integer.parseInt(Constants.mAccount.getIntegral())+score)+"积分");
		textView.setText(msg);
		Toast toast = new Toast(this);
		toast.setDuration(10000);
		toast.setView(view);
