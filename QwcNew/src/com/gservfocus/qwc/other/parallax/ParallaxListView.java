package com.gservfocus.qwc.other.parallax;
...
public class ParallaxListView extends ListView implements OnScrollListener {
    ...
    private ArrayList<com.gservfocus.qwc.other.parallax.OnOverScrollByListener> mOnOverScrollByList = new ArrayList<com.gservfocus.qwc.other.parallax.OnOverScrollByListener>();
    ...
    private com.gservfocus.qwc.other.parallax.OnOverScrollByListener onScroll = new com.gservfocus.qwc.other.parallax.OnOverScrollByListener() {
    ...
    private void addOnScrolledListener(com.gservfocus.qwc.other.parallax.OnOverScrollByListener onScrolled) {
